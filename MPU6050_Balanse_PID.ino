...
// *********************************************************************
char PWM1[] = {10, 5}; //Номера пинов для ШИМ управления
char Umotor_1[] = {8, 9}; //Подключение первого двигателя
char Umotor_2[] = {6, 7}; //Подключение первого двигателя
//Переменные для ПИД регулятора
// *********************************************************************
double originalSetpoint = 0.18;//Требуемое значение стабилизации
double setpoint = originalSetpoint;
double movingAngleOffset = 0;
double input, output;
double Kp = 28.5;   //28.5//50 Это примеры моих значений 
double Kd = 0.9;    //0.9//0.5
double Ki = 250;    //250//420
